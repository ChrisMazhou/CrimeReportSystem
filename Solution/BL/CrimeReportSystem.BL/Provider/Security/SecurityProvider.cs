...
using CrimeReportSystem.BL.Provider.Email;
using CrimeReportSystem.BL.Settings;
using CrimeReportSystem.BL.Types;
using CrimeReportSystem.BL.Util;
using System.Data.Entity;
using CrimeReportSystem.BL.Provider.Security;

namespace CrimeReportSystem.BL.Provider.Security
{
    public class SecurityProvider : CrimeReportSystemProvider, ISecurityProvider
    {
        #region Ctor
